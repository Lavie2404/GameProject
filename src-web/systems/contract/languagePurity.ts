...
const RULE_BODY = [
  ...
  "//    - CHỮ QUỐC NGỮ PHẢI CÓ ĐẦY ĐỦ DẤU (dấu chữ ă â đ ê ô ơ ư và dấu thanh sắc, huyền, hỏi, ngã, nặng). Viết tiếng Việt KHÔNG DẤU là vi phạm luật này. VÍ DỤ SAI: \"Mat su an danh tu Thuong Son, che giau than phan that\" — phải viết \"Mật sứ ẩn danh từ Thường Sơn, che giấu thân phận thật\".",
